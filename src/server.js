...
const i_env = {
   ...
   server: {
      host: process.env.CODON_HOST || '127.0.0.1',
      port: parseInt(process.env.CODON_PORT || '8080'),
      staticDir: (
         process.env.CODON_STATIC_DIR?
         i_path.resolve(process.env.CODON_STATIC_DIR):null
      ),
      httpsCADir: (
         process.env.CODON_HTTPS_CA_DIR?
         i_path.resolve(process.env.CODON_HTTPS_CA_DIR):null
      ),
   },
};
