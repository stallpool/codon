// copy from https://github.com/dna2github/dna2petal/blob/master/visualization/petal-interactions.js
// modified for one finger touch move, start and end by Seven Lju @ 2019-03-12
      ...
      if (config.pinch.enable) {
         if (callback.touchpinch) {
            switch (e.type) {
               case 'touchmove':
                  if (touches.length === 1) {
                     callback.touchmove && callback.touchmove(e.target, e.changedTouches[0]);
                     break;
                  }
                  ...
                  return;
               case 'touchstart':
                  callback.touchstart && callback.touchstart(e.target, e.changedTouches[0]);
                  do_pinch_down(e);
                  break;
               case 'touchend':
                  callback.touchend && callback.touchend(e.target, e.changedTouches[0]);
                  do_pinch_up(e);
